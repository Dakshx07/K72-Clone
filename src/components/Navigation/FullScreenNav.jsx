            ...
            <div ref={fullNavLinkRef} className='relative'>
                <div className='navlinks flex w-full items-start p-2  justify-between'>
                    ...
                    <div onClick={() => {
                        ...
                        <div className='h-40 w-1 absolute -rotate-48 origin-top bg-[#D3FD50]'></div>
                        <div className='h-40 w-1 absolute right-0 rotate-48 origin-top bg-[#D3FD50]'></div>
                ...
                <div className='flex pt-4 text-2xl font-[font1]'>
                    <h6 >MONTREAL_</h6>
                    <LiveClock />
                </div>
            </div>
